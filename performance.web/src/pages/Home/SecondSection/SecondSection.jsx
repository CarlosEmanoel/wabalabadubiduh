import { PDefaultButton, PFileFetcher, PSectionContainer } from '../../../components';

export default function SecondSection() {
    return (
        <PSectionContainer className={'bg-primary_blue xl:bg-gradient-to-r xl:from-transparent xl:from-50% xl:via-primary_blue_hover xl:via-30% xl:to-primary_blue xl:to-80% xl:bg-transparent'}>
            <div className="relative px-4 xl:text-primary_blue text-white">
                <div className="flex xl:flex-row items-center justify-center py-16 lg:flex-col-reverse">
                    <div className="relative text-center lg:text-left">
                        <p className="flex uppercase text-2xl font-normal justify-center lg:justify-start">
                            seja você
                        </p>
                        ...
                        <p className="text-base text-white xl:text-primary_blue">
                            Desenvolva suas habilidades com nosso time de ensino totalmente preparado
                        </p>
                        <p className="text-base text-white xl:text-primary_blue">
