...
const tabBarCardVariants = tv({
    ...
    variants: {
        size: {
            'xs': 'w-[80vw] flex-col select-none mx-auto my-4 rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            'sm': 'w-[80vw] flex-col select-none mx-auto my-4 rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            'md': 'w-[80vw] flex-col select-none mx-auto my-4 rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            'lg': 'w-[80vw] flex-col select-none mx-auto my-4 rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            'xl': 'w-[90vw] relative select-none mx-auto my-4 flex flex-row rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            '2xl': 'w-[90vw] relative select-none mx-auto my-4 flex flex-row rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            '3xl': 'w-[90vw] relative select-none mx-auto my-4 flex flex-row rounded-xl bg-slate-100 text-primary_blue shadow-lg',
            '4xl': 'w-[90vw] relative select-none mx-auto my-4 flex flex-row rounded-xl bg-slate-100 text-primary_blue shadow-lg',
        },
        photoSize: {
            ...
            'xl': 'relative min-h-[60vh] max-h-[60vh] m-0 w-1/2 flex items-center shrink-0 overflow-hidden rounded-xl rounded-l-xl rounded-r-none bg-white bg-clip-border text-primary_blue',
            '2xl': 'relative min-h-[60vh] max-h-[60vh] m-0 w-1/2 flex items-center shrink-0 overflow-hidden rounded-xl rounded-l-xl rounded-r-none bg-white bg-clip-border text-primary_blue',
            '3xl': 'relative min-h-[60vh] max-h-[60vh] m-0 w-1/2 flex items-center shrink-0 overflow-hidden rounded-xl rounded-l-xl rounded-r-none bg-white bg-clip-border text-primary_blue',
            '4xl': 'relative min-h-[60vh] max-h-[60vh] m-0 w-1/2 flex items-center shrink-0 overflow-hidden rounded-xl rounded-l-xl rounded-r-none bg-white bg-clip-border text-primary_blue',
        },
        mms: {
