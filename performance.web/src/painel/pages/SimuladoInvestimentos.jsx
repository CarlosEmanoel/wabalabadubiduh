...
function SimuladoInvestimentos() {
  ...
  const carregarLista = async () => {
    ...
    const buscarQuestoesPorNivel = async (nivel) => {
      let url = `/questoes?tipo=2?nivel=${nivel}`;
    ...
    setQuestoesExibidas(dadosCombinados.slice(indexOfFirstQuestion, indexOfLastQuestion));
  };
...
export default SimuladoInvestimentos;
