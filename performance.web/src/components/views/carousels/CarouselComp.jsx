  ...
  return (
    ...
    >
      <div
        ...
        className='bg-black flex justify-center items-center w-24 h-24 absolute left-0 rounded-l-xl sm:w-32 sm:h-32 xl:w-56 xl:h-32 lg:relative cursor-pointer group duration-300 ease-in-out transition-transform transform hover:scale-105 z-10'
      >
        <PFileFetcher
      ...
      <div className='w-[100vw] h-[57vh] rounded-xl xl:w-[43vw] lg:w-[63vw] flex justify-center items-center overflow-hidden'>
        <div
      ...
      <div
        ...
        className='bg-black flex justify-center items-center w-24 h-24 absolute right-0 rounded-r-xl sm:w-32 sm:h-32 xl:w-56 xl:h-32 lg:relative cursor-pointer group duration-300 ease-in-out transition-transform transform hover:scale-105 z-10'
      >
        <PFileFetcher
