...
export default function InputCodeVerify({
  ...
  return (
    <div className="flex flex-col items-center space-y-4 select-none">
      ...
      <div className="flex space-x-2">
        {code.map((value, index) => (
          <input
            ...
            type="text"
            maxLength="1"
            className="w-12 h-12 text-center border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-yellow-500"
            value={value}
      ...
      {error && <p className="text-red-500">Por favor, preencha todos os blocos.</p>}
