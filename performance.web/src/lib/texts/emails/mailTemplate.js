        ...
        <tr>
            <td bgcolor="#007FC5" style="padding: 20px 30px 20px 30px;">
                <div style="display: flex; justify-content: center; align-items: center; padding-bottom: 10px;">
                    ...
                    <a href="https://www.instagram.com/performancegoiania" target="_blank" style="color: #ffffff; padding-left: 20px; padding-right: 20px;">
                        Instagram
                    </a>
                ...
                <p style="color: #ffffff; text-align: center; margin: 10px;">&copy; ${year}, <a
                        href="https://performance.goiania.br/" style="color: #ffffff;">Performance Goiânia™</a>. Todos
